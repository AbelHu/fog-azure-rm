  ...
  module Storage
    class AzureRM
      ...
      class File < Fog::Model
        ...
        # The maximum size for a block blob created via Put Blob is 64 MB. If your blob is larger than 64 MB, you must upload it as a set of blocks.
        SINGLE_BLOB_PUT_THRESHOLD = 64 * 1024 * 1024
        ...
        def copy(target_directory_key, target_file_key, options = {})
          ...
          wait_copy_operation_to_finish(target_directory_key, target_file_key, copy_id, copy_status)
        ...
        def copy_from_uri(source_uri, options = {})
          ...
          wait_copy_operation_to_finish(directory.key, key, copy_id, copy_status)
        ...
        def wait_copy_operation_to_finish(target_directory_key, target_file_key, copy_id, copy_status)
          start_time = Time.new
